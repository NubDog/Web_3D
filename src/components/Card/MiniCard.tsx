    ...
    return (
        <div className="Card-container">
            <div className="Card-title-container">
                <h2 className="Card-title">Shark Eat Rice tạo nên mọi khác biệt. <span>Thêm nhiều lý do để thuê xe cùng chúng tôi</span></h2>
            </div>
                ...
                <div className="Card-scroll-buttons">
                    ...
                    <div className="Card-content MiniCard-content MiniCard-box-darkblue">
                        ...
                        <div className="Card-content-title">
                            ...
                            <p>
                                Trải nghiệm
                                <span> thuê xe được cá nhân hóa </span>
                                với
